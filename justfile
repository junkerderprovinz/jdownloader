# Task runner for the JDownloader container. Recipes run under sh (Git Bash on Windows).
...
# ShellCheck the init scripts, honouring their shebangs like CI does
shellcheck:
...
notes version:
    ...
    @echo "Wrote .github/release-notes/v{{version}}.md, edit it and commit."
