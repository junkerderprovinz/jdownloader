...
Unraid, with a fully **dark** UI out of the box. The whole interface
...
- Image: `ghcr.io/junkerderprovinz/jdownloader:latest` (amd64 and arm64) · also `junkerderprovinz/jdownloader` on Docker Hub
- Changelog: https://github.com/junkerderprovinz/jdownloader/releases

**Features** (what sets it apart first)
- 🌑 **Complete dark UI**: monochrome IBM Carbon `#161616` across the *whole* interface (download list, link grabber *and* settings), not just the menu bar
...
- 🧩 One container, amd64 and arm64, built on LinuxServer's `baseimage-selkies`
